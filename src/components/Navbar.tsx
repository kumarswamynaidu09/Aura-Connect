    ...
    <header className="sticky top-0 z-50 w-full border-b border-zinc-800/80 bg-zinc-950/75 backdrop-blur-xl transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-monad-600 via-indigo-500 to-purple-400 p-[1px] shadow-lg shadow-monad-500/20">
            <div className="w-full h-full bg-zinc-950 rounded-[11px] flex items-center justify-center">
              <Cpu className="w-5 h-5 text-monad-400 animate-pulse-subtle" />
            </div>
          </div>
          <div>
            <div className="flex items-center space-x-2">
              <span className="font-bold text-lg tracking-tight bg-gradient-to-r from-white via-zinc-200 to-monad-300 bg-clip-text text-transparent">
                AURA CONNECT
              </span>
              <span className="px-2 py-0.5 text-[10px] font-semibold tracking-wide uppercase rounded-full bg-monad-500/15 text-monad-300 border border-monad-500/30">
                Monad
              </span>
            </div>
                    ...
                    if (!connected) {
                      return (
                        <button
                          ...
                          type="button"
                          className="px-4 py-2 rounded-xl bg-gradient-to-r from-monad-600 to-indigo-600 hover:from-monad-500 hover:to-indigo-500 text-white text-xs font-semibold shadow-lg shadow-monad-600/25 transition flex items-center space-x-2"
                        >
                    ...
                    return (
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          type="button"
                          className="px-3 py-1.5 rounded-lg bg-monad-950/80 border border-monad-600/40 text-xs text-monad-200 hover:bg-monad-900/60 font-mono font-medium transition"
                        >
                          {account.displayName}
